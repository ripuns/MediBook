              ...
              {loading ? (
                ...
                appointments.map((appointment) => (
                  <tr key={appointment.id} className="border-t">
                    ...
                    <td className="px-4 py-3">
                      <div className="font-medium">{appointment.doctor?.user?.name ? `Dr. ${appointment.doctor.user.name}` : 'Doctor'}</div>
                      <div className="text-xs text-gray-500">{appointment.doctor?.user?.email}</div>
                    </td>
                    <td className="px-4 py-3">
